...
local abilities_dictionary = {
    ...
    jakiro_ice_path = function (ability)
        return {
            ...
            duration = ability:GetSpecialValueFloat("duration"),
            target_flags = ability:GetTargetFlags(),
    ...
    jakiro_macropyre = function (ability)
        return {
            ...
            duration = ability:GetSpecialValueInt("linger_duration"),
            target_flags = ability:GetTargetFlags(),
    ...
    sven_storm_bolt = function (ability)
        return {
            ...
            duration = ability:GetSpecialValueFloat("bolt_stun_duration"),
            target_flags = ability:GetTargetFlags(),
    ...
    sven_warcry = function (ability)
        return {
            ...
            cast_delay = ability:GetCastPoint(),
            damage = 0,
            duration = ability:GetSpecialValueInt("duration"),
            target_flags = ability:GetTargetFlags(),
            modifier = "modifier_sven_warcry",
            timer = enums.timer.BUFF,
        };
    end,
    ...
    sniper_shrapnel = function (ability)
        return {
            ...
            duration = ability:GetSpecialValueFloat("slow_duration"),
            target_flags = ability:GetTargetFlags(),
    ...
    necrolyte_reapers_scythe = function (ability)
        return {
            ...
            aoe_radius = 0,
            damage = 0,
            duration = ability:GetSpecialValueFloat("stun_duration"),
            target_flags = ability:GetTargetFlags(),
    ...
    sandking_burrowstrike = function (ability)
        return {
            ...
            cast_delay = ability:GetCastPoint(),
            damage = ability:GetAbilityDamage(),
            duration = ability:GetSpecialValueFloat("burrow_duration"),
            target_flags = ability:GetTargetFlags(),
